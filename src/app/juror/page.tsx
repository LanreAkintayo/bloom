        ...
        <div className="space-y-4">
          {activeTab === "active" &&
            dummyDisputes.active.map((dispute) => (
              <Card
                key={dispute.id}
                className="bg-gradient-to-br from-slate-900/95 via-slate-950 to-black/95 border border-cyan-500/30 shadow-md hover:shadow-2xl hover:scale-[1.02] transition-all rounded-2xl p-5 flex flex-col md:flex-row justify-between gap-4 relative overflow-hidden"
              >
          ...
          {activeTab === "past" &&
            dummyDisputes.past.map((dispute) => (
              <Card
                key={dispute.id}
                className="bg-gradient-to-br from-slate-900/90 via-slate-950 to-black/90 border border-cyan-500/30  shadow-md hover:shadow-xl transition-all rounded-2xl p-5 flex flex-col md:flex-row justify-between gap-4 relative overflow-hidden"
              >
